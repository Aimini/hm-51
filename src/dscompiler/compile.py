...
if __name__ == "__main__":
    ...
    arg_parser.add_option('-s', '--preprocess-file', action='store', type="string", dest='preprocess_file', default=None,help = "the file to store preprocessed content.")
    iarg = sys.argv[1:]
    darg = ['-i', R"src\decoder\decoder.ds","-o",R"temp\decoder.bin", "-d", R"temp\decoder.disa",'-s',R'temp\decoder.pre']
